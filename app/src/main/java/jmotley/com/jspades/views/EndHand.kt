...
private val HEADER = Color(0xFFB0BEC5)   // cool grey
...
private fun TeamStatsTable(
    ...
    Row(Modifier.fillMaxWidth()) {
        ...
        Text("US",   modifier = Modifier.weight(1f), textAlign = TextAlign.Center, color = GOLD,        fontWeight = FontWeight.Bold, fontSize = 13.sp)
